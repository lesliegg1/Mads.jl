...
Mads.mads@info("Forward run ...")
Mads.plotmatches(md)

Mads.mads@info("Local sensitivity analysis ...")
localsaresult = Mads.localsa(md, format="PNG")
stddev = localsaresult["stddev"]
Mads.mads@info("Posterior parameter uncertainty ranges (centered at the initial paramter estimates) ...")
...
Mads.mads@info("Posterior (Bayesian) spaghetti plots ...")
